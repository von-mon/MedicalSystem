...
<body>
<form action="${pageContext.request.contextPath}/medicine/edit" method="post" enctype="multipart/form-data" class="definewidth m20">
    <input type="hidden" name="mid" value="${medicine.mid}"/>
<%--    <input type="hidden" name="_method" value="PUT"/>--%>
    <table class="table table-bordered table-hover definewidth m10">
        <%--    <tr>--%>
        <%--        <td width="10%" class="tableleft">药品编号</td>--%>
        <%--        <td><input type="text" name="mid"  readonly="readonly"/>${medicine.mid}</td>--%>
        <%--    </tr>--%>
        <tr>
