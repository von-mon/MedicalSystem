...
<%--    <script type="text/javascript" src="../Js/jquery.sorted.js"></script>--%>
    ...
    $(function () {       
		...
		$("#cardno").blur(function () {
		    ...
		    if(!reg.test(card)){
		        $("#error_cardno").text("身份证号格式不正确").css("color","red");
                return;
            }
        });
		...
		$("#phone").blur(function () {
            ...
            if(!reg.test(phone)){
                $("#error_cardno").text("手机号格式不正确").css("color","red");
                return;
            }
        });
		...
		$("#email").blur(function () {
            ...
            if (!emailReg.test(email)) {
                $("#error_email").text("邮箱格式不正确").css({"color": "red"});
                return;
            }
        });
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input id="cardno" type="text" name="cardno" value=""/></td>
        <td><span id="error_cardno"></span></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">手机</td>
        <td><input id="phone" type="text" name="phone" value=""/></td>
        <td><span id="error_phone"></span></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input id="birthday" type="text" name="birthday" class="Wdate" onclick="WdatePicker({el:this,maxDate:'%y-%M-%d'})" value=""/></td>
        <td></td>
    </tr>
    <tr>
